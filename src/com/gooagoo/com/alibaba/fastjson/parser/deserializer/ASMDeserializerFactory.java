...
import static com.gooagoo.com.alibaba.fastjson.util.ASMUtils.desc;
import static com.gooagoo.com.alibaba.fastjson.util.ASMUtils.type;
...
import com.gooagoo.com.alibaba.fastjson.asm.ClassWriter;
import com.gooagoo.com.alibaba.fastjson.asm.FieldWriter;
import com.gooagoo.com.alibaba.fastjson.asm.Label;
import com.gooagoo.com.alibaba.fastjson.asm.MethodVisitor;
import com.gooagoo.com.alibaba.fastjson.asm.MethodWriter;
import com.gooagoo.com.alibaba.fastjson.asm.Opcodes;
import com.gooagoo.com.alibaba.fastjson.parser.DefaultJSONParser;
import com.gooagoo.com.alibaba.fastjson.parser.DefaultJSONParser.ResolveTask;
...
public class ASMDeserializerFactory implements Opcodes {
    ...
    private void _deserialzeArrayMapping(ClassWriter cw, Context context) {
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == byte.class //
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitLdcInsn(com.gooagoo.com.alibaba.fastjson.asm.Type.getType(desc(fieldClass)));
                ...
                if (itemClass == String.class) {
                    ...
                    mw.visitLdcInsn(com.gooagoo.com.alibaba.fastjson.parser.JSONLexerBase.VALUE_NULL);
                    ...
                    mw.visitVarInsn(ALOAD, 1);
                    mw.visitLdcInsn(com.gooagoo.com.alibaba.fastjson.asm.Type.getType(desc(itemClass)));
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitLdcInsn(com.gooagoo.com.alibaba.fastjson.parser.JSONToken.LBRACKET);
                mw.visitMethodInsn(INVOKEVIRTUAL, JSONLexerBase, "nextToken", "(I)V");
    ...
    private void _deserialze(ClassWriter cw, Context context) {
        ...
        mw.visitLdcInsn(com.gooagoo.com.alibaba.fastjson.parser.JSONLexerBase.NOT_MATCH);
        ...
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitFieldInsn(GETFIELD, JSONLexerBase, "matchStat", "I");
        mw.visitLdcInsn(com.gooagoo.com.alibaba.fastjson.parser.JSONLexerBase.END);
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == boolean.class) {
                ...
                if (itemClass == String.class) {
                    mw.visitLdcInsn(com.gooagoo.com.alibaba.fastjson.asm.Type.getType(desc(fieldClass))); // cast
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitLdcInsn(com.gooagoo.com.alibaba.fastjson.asm.Type.getType(desc(itemType)));
        mw.visitInsn(ICONST_0);
    ...
    private void _deserialze_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitLdcInsn(com.gooagoo.com.alibaba.fastjson.parser.DefaultJSONParser.NeedToResolve);
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitLdcInsn(com.gooagoo.com.alibaba.fastjson.parser.DefaultJSONParser.NONE);
    ...
    private void _deserObject(Context context, MethodVisitor mw, FieldInfo fieldInfo, Class<?> fieldClass, int i) {
        ...
        if ((fieldInfo.parserFeatures & Feature.SupportArrayToBean.mask) != 0) {
            ...
            if (fieldInfo.fieldType instanceof Class) {
                mw.visitLdcInsn(com.gooagoo.com.alibaba.fastjson.asm.Type.getType(desc(fieldInfo.fieldClass)));
            } else {
                mw.visitVarInsn(ALOAD, 0);
                mw.visitLdcInsn(i);
                mw.visitMethodInsn(INVOKEVIRTUAL, type(JavaBeanDeserializer.class), "getFieldType",
