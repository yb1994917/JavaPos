package com.gooagoo.jackson.databind.module;
...
import com.gooagoo.jackson.databind.type.ClassKey;
import com.gooagoo.jackson.databind.type.CollectionLikeType;
import com.gooagoo.jackson.databind.type.CollectionType;
import com.gooagoo.jackson.databind.type.MapLikeType;
import com.gooagoo.jackson.databind.type.MapType;
    ...
    public void addSerializer(JsonSerializer<?> ser)
    {
        ...
        if (cls == null || cls == Object.class) {
            throw new IllegalArgumentException("JsonSerializer of type "+ser.getClass().getName()
                    ...
                    +" or make serializer extend 'com.gooagoo.jackson.databind.ser.std.StdSerializer'"); 
        }
