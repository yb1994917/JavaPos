...
public class OptionalHandlerFactory implements java.io.Serializable
{
    ...
    private final static String SERIALIZERS_FOR_JAVAX_XML = "com.gooagoo.jackson.databind.ext.CoreXMLSerializers";
    private final static String DESERIALIZERS_FOR_JAVAX_XML = "com.gooagoo.jackson.databind.ext.CoreXMLDeserializers";
...
//    private final static String CLASS_NAME_DOM_DOCUMENT = "org.w3c.dom.Document";
    private final static String SERIALIZER_FOR_DOM_NODE = "com.gooagoo.jackson.databind.ext.DOMSerializer";
    private final static String DESERIALIZER_FOR_DOM_DOCUMENT = "com.gooagoo.jackson.databind.ext.DOMDeserializer$DocumentDeserializer";
    private final static String DESERIALIZER_FOR_DOM_NODE = "com.gooagoo.jackson.databind.ext.DOMDeserializer$NodeDeserializer";
