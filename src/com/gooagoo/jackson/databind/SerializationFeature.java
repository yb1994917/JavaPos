...
import com.gooagoo.jackson.databind.cfg.ConfigFeature;
...
public enum SerializationFeature implements ConfigFeature
{
     ...
     * no explicit {@link com.gooagoo.jackson.core.PrettyPrinter} has been configured
     ...
     * in conjunction with {@link com.gooagoo.jackson.annotation.JsonUnwrapped}.
     ...
     * {@link com.gooagoo.jackson.databind.SerializationConfig#getDateFormat}:
     * the default setting being {@link com.gooagoo.jackson.databind.util.StdDateFormat},
     ...
     *   using {@link com.gooagoo.jackson.annotation.JsonInclude} or configuration overrides.
     */
     ...
     * {@link com.gooagoo.jackson.core.JsonGenerator#writeNumber(String)}
     * it may cause compatibility problems since not all {@link com.gooagoo.jackson.core.JsonGenerator}
     * implementations support such mode of output: usually only text-based formats
     * support it.
     *<p>
     * Feature is disabled by default.
     * 
     * @deprecated Since 2.5: use {@link com.gooagoo.jackson.core.JsonGenerator.Feature#WRITE_BIGDECIMAL_AS_PLAIN} instead
     *    (using {@link ObjectWriter#with(com.gooagoo.jackson.core.JsonGenerator.Feature)}).
     */
