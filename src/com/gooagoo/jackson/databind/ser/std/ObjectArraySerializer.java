...
import com.gooagoo.jackson.databind.jsonFormatVisitors.JsonArrayFormatVisitor;
...
import com.gooagoo.jackson.databind.ser.ContainerSerializer;
import com.gooagoo.jackson.databind.ser.ContextualSerializer;
import com.gooagoo.jackson.databind.ser.impl.PropertySerializerMap;
import com.gooagoo.jackson.databind.type.ArrayType;
        ...
        if (typeHint != null) {
            ...
            if (javaType.isArrayType()) {
                ...
                if (componentType == Object.class) {
                    o.set("items", com.gooagoo.jackson.databind.jsonschema.JsonSchema.getDefaultSchemaNode());
                } else {
                    JsonSerializer<Object> ser = provider.findValueSerializer(componentType, _property);
                    JsonNode schemaNode = (ser instanceof SchemaAware) ?
                            ((SchemaAware) ser).getSchema(provider, null) :
                            	com.gooagoo.jackson.databind.jsonschema.JsonSchema.getDefaultSchemaNode();
