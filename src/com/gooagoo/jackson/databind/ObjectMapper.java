...
import com.gooagoo.jackson.annotation.JsonAutoDetect;
import com.gooagoo.jackson.annotation.JsonInclude;
import com.gooagoo.jackson.annotation.JsonTypeInfo;
import com.gooagoo.jackson.annotation.PropertyAccessor;
import com.gooagoo.jackson.core.Base64Variant;
import com.gooagoo.jackson.core.Base64Variants;
import com.gooagoo.jackson.core.FormatSchema;
import com.gooagoo.jackson.core.JsonEncoding;
import com.gooagoo.jackson.core.JsonFactory;
import com.gooagoo.jackson.core.JsonGenerationException;
import com.gooagoo.jackson.core.JsonGenerator;
import com.gooagoo.jackson.core.JsonParseException;
import com.gooagoo.jackson.core.JsonParser;
import com.gooagoo.jackson.core.JsonProcessingException;
import com.gooagoo.jackson.core.JsonToken;
import com.gooagoo.jackson.core.ObjectCodec;
import com.gooagoo.jackson.core.PrettyPrinter;
import com.gooagoo.jackson.core.TreeNode;
import com.gooagoo.jackson.core.Version;
import com.gooagoo.jackson.core.Versioned;
import com.gooagoo.jackson.core.io.CharacterEscapes;
import com.gooagoo.jackson.core.io.SegmentedStringWriter;
import com.gooagoo.jackson.core.type.ResolvedType;
import com.gooagoo.jackson.core.type.TypeReference;
import com.gooagoo.jackson.core.util.ByteArrayBuilder;
import com.gooagoo.jackson.databind.cfg.BaseSettings;
import com.gooagoo.jackson.databind.cfg.ConfigOverrides;
import com.gooagoo.jackson.databind.cfg.ContextAttributes;
import com.gooagoo.jackson.databind.cfg.HandlerInstantiator;
import com.gooagoo.jackson.databind.cfg.MapperConfig;
import com.gooagoo.jackson.databind.cfg.MutableConfigOverride;
import com.gooagoo.jackson.databind.deser.BeanDeserializerFactory;
import com.gooagoo.jackson.databind.deser.BeanDeserializerModifier;
import com.gooagoo.jackson.databind.deser.DefaultDeserializationContext;
import com.gooagoo.jackson.databind.deser.DeserializationProblemHandler;
import com.gooagoo.jackson.databind.deser.DeserializerFactory;
import com.gooagoo.jackson.databind.deser.Deserializers;
import com.gooagoo.jackson.databind.deser.KeyDeserializers;
import com.gooagoo.jackson.databind.deser.ValueInstantiators;
import com.gooagoo.jackson.databind.introspect.BasicClassIntrospector;
import com.gooagoo.jackson.databind.introspect.ClassIntrospector;
import com.gooagoo.jackson.databind.introspect.JacksonAnnotationIntrospector;
import com.gooagoo.jackson.databind.introspect.SimpleMixInResolver;
import com.gooagoo.jackson.databind.introspect.VisibilityChecker;
...
import com.gooagoo.jackson.databind.jsontype.SubtypeResolver;
...
import com.gooagoo.jackson.databind.jsontype.impl.StdSubtypeResolver;
import com.gooagoo.jackson.databind.jsontype.impl.StdTypeResolverBuilder;
import com.gooagoo.jackson.databind.node.ArrayNode;
import com.gooagoo.jackson.databind.node.JsonNodeFactory;
import com.gooagoo.jackson.databind.node.NullNode;
import com.gooagoo.jackson.databind.node.ObjectNode;
import com.gooagoo.jackson.databind.node.POJONode;
import com.gooagoo.jackson.databind.node.TreeTraversingParser;
import com.gooagoo.jackson.databind.ser.BeanSerializerFactory;
import com.gooagoo.jackson.databind.ser.BeanSerializerModifier;
import com.gooagoo.jackson.databind.ser.DefaultSerializerProvider;
import com.gooagoo.jackson.databind.ser.FilterProvider;
import com.gooagoo.jackson.databind.ser.SerializerFactory;
import com.gooagoo.jackson.databind.ser.Serializers;
import com.gooagoo.jackson.databind.type.SimpleType;
import com.gooagoo.jackson.databind.type.TypeFactory;
import com.gooagoo.jackson.databind.type.TypeModifier;
import com.gooagoo.jackson.databind.util.ClassUtil;
import com.gooagoo.jackson.databind.util.RootNameLookup;
import com.gooagoo.jackson.databind.util.StdDateFormat;
import com.gooagoo.jackson.databind.util.TokenBuffer;
...
<pre>
  ...
  // and find values by, for example, using a {@link com.gooagoo.jackson.core.JsonPointer} expression:
...
//            TypeFactory.defaultInstance().constructType(JsonNode.class);
    ...
    public Version version() {
        return com.gooagoo.jackson.databind.cfg.PackageVersion.VERSION;
    }
    ...
    */
     ...
     * have a look at {@link com.gooagoo.jackson.databind.introspect.AnnotationIntrospectorPair}.
     * 
     * @see com.gooagoo.jackson.databind.introspect.AnnotationIntrospectorPair
     */
     ...
     * have been annotated with {@link com.gooagoo.jackson.annotation.JsonTypeInfo}).
     *<P>
     ...
     * {@link com.gooagoo.jackson.annotation.JsonTypeInfo}) will have
    ...
    /**
     * Method for changing state of specified {@link com.gooagoo.jackson.core.JsonParser.Feature}s
    ...
    /**
     * Method for enabling specified {@link com.gooagoo.jackson.core.JsonParser.Feature}s
     * for parser instances this object mapper creates.
     *<p>
    ...
    /**
     * Method for disabling specified {@link com.gooagoo.jackson.core.JsonParser.Feature}s
     * for parser instances this object mapper creates.
     *<p>
     * Note that this is equivalent to directly calling same method on {@link #getFactory}.
     *
    ...
    /**
     * Method for enabling specified {@link com.gooagoo.jackson.core.JsonGenerator.Feature}s
     * for parser instances this object mapper creates.
     *<p>
     * Note that this is equivalent to directly calling same method on {@link #getFactory}.
     *
    ...
    /**
     * Method for disabling specified {@link com.gooagoo.jackson.core.JsonGenerator.Feature}s
     * for parser instances this object mapper creates.
     *<p>
     * Note that this is equivalent to directly calling same method on {@link #getFactory}.
     *
     ...
     * raw value ({@link com.gooagoo.jackson.databind.util.RawValue}) or basic
     ...
     *  {@link com.gooagoo.jackson.databind.node.ObjectNode}
     ...
     */
    @Deprecated
    public com.gooagoo.jackson.databind.jsonschema.JsonSchema generateJsonSchema(Class<?> t)
